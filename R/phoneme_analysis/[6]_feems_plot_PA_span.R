...
phon_surface      <- read.csv(here("data", "feems", "phoneme_surface_raster.csv"))
phon_surface_null <- read.csv(here("data", "feems", "phoneme_surface_raster_null_mean.csv"))
PHONEME_cossim    <- read.csv(here("data", "cosine_similarity", "PHONEME_cossim.csv"))
...
subgroup_lookup <- read.csv(here("data", "phoneme", "PHONEME_subgroup_lookup.csv"))
...
base_plot
saveRDS(base_plot, file = here("data", "feems", "base_plot_phoneme_FEEMS.rds"))
...
base_plot_null
saveRDS(base_plot_null, file = here("data", "feems", "base_plot_phoneme_FEEMS_null.rds"))
...
legend_strip
saveRDS(legend_strip, file = here("data", "feems", "legend_strip_phoneme_subgroup.rds"))
