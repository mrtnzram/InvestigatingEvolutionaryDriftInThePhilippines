# =============================================================================
# [7] Grammar Analysis — Overlay waypoint routes on the FEEMS base map
# Combines the FEEMS migration surface (base_plot_grammar_FEEMS, from [6]) with
# the historical migration-route arrows and marks the colonial capital (Manila),
# then saves the combined figure.
#
# Input:   data/base_plot_grammar_FEEMS.rds (from [6]),
#          data/grammar_waypoint_plot.rds (arrow layers, from [3])
# Outputs: figures/grammar/mst_waypoints/GA_weight_mst_feems.png
# =============================================================================
...
base_plot <- readRDS(here("data", "base_plot_grammar_FEEMS.rds"))
...
ggsave(here("figures", "grammar", "mst_waypoints", "GA_weight_mst_feems.png"),
       final_plot_GA_, width = 7, height = 9, units = "in", dpi = 300)
