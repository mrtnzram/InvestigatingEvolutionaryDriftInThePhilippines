...
gram_surface      <- read.csv(here("data", "feems", "grammar_surface_raster.csv"))
gram_surface_null <- read.csv(here("data", "feems", "grammar_surface_raster_null_mean.csv"))
GRAMMAR_cossim    <- read.csv(here("data", "cosine_similarity", "GRAMMAR_cossim.csv"))
...
subgroup_lookup <- read.csv(here("data", "grammar", "GRAMMAR_subgroup_lookup.csv"))
...
base_plot
saveRDS(base_plot, file = here("data", "feems", "base_plot_grammar_FEEMS.rds"))
...
base_plot_null
saveRDS(base_plot_null, file = here("data", "feems", "base_plot_grammar_FEEMS_null.rds"))
...
legend_strip
saveRDS(legend_strip, file = here("data", "feems", "legend_strip_grammar_subgroup.rds"))
