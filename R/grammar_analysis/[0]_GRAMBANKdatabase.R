...
values <- read_csv(here("data", "shared", "values.csv"), show_col_types = FALSE)
...
RUHLENdf_PH <- read_csv(here("data", "phoneme", "RUHLENdf_PH.csv"), show_col_types = FALSE)
...
write_csv(GRAMBANKdf_full, here("data", "grammar", "GRAMBANKdf_full.csv"))
...
write_csv(gramfeature_freq, here("data", "grammar", "gramfeature_freq.csv"))
