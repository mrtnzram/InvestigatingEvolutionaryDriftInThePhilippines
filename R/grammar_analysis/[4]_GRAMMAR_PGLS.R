...
# Input:   data/GRAMMAR_cossim_dist.csv (from [3]_GRAMMAR_network_distance.R)
...
GRAMMAR_cossim_dist <- read.csv(here("data", "GRAMMAR_cossim_dist.csv"))
