...
# Outputs: data/pvr/GRAMMAR_geo_vs_ancestry.csv                       (§4 results table)
#          figures/regression/grammar_regression_geography.png          (y vs. distance)
...
write.csv(GRAMMAR_geo_vs_ancestry,
          file = here("data", "pvr", "GRAMMAR_geo_vs_ancestry.csv"),
          row.names = FALSE)
