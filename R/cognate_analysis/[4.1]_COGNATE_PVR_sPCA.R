...
# Outputs: data/pvr_mem/COGNATE_pvr_spca_results.csv, data/pvr_mem/COGNATE_spca_scores.csv
#          data/pvr_mem/base_plot_cognate_PVR_sPCA.rds
...
write.csv(scores_df, file = here("data", "pvr_mem", "COGNATE_spca_scores.csv"),
          row.names = FALSE)
...
write.csv(COGNATE_pvr_spca_results,
          file = here("data", "pvr_mem", "COGNATE_pvr_spca_results.csv"), row.names = FALSE)
...
saveRDS(p_surface, file = here("data", "pvr_mem", "base_plot_cognate_PVR_sPCA.rds"))
