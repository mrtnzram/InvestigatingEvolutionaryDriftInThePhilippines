...
RUHLENdf <- read_csv(here("data", "phoneme", "RUHLENdf_PH_evolutionary.csv"), show_col_types = FALSE)

RUHLENdf_full <- read_csv(here("data", "phoneme", "RUHLENdf_PH.csv"), show_col_types = FALSE)

phoneme_freq <- read_csv(here("data", "phoneme", "phoneme_freq_ruhlen_evolutionary.csv"), show_col_types = FALSE)
tip_mapping <- read_csv(here("data", "phoneme", "phoneme_evolutionary_tip_mapping.csv"), show_col_types = FALSE)
analysis_objects <- readRDS(here("data", "phoneme", "phoneme_evolutionary_analysis_tree.rds"))
