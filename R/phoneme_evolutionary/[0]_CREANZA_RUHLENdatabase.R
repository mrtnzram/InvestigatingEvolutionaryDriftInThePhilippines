...
lines <- readLines(here("data", "phoneme", "pnas_1424033112_sd01.txt"))
...
languages <- read_csv(here("data", "shared", "languages.csv"), show_col_types = FALSE)
...
write_csv(PHOIBLEdf_PH, here("data", "phoneme", "RUHLENdf_PH_evolutionary.csv"))
...
write_csv(phoneme_freq_austronesian, here("data", "phoneme", "phoneme_freq_ruhlen_evolutionary.csv"))
...
write_csv(pnas_key, here("data", "phoneme", "phoneme_key_pnas.csv"))
